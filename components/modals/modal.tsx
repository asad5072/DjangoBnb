			...
			<div className="relative w-[90%] md:w-[80%] lg:w[700px] my-6 h-auto mx-auto">
				...
				>
					<div className="w-full h-auto rounded-xl relative flex flex-col bg-white">
						<header className="flex items-center justify-center relative p-6 rounded-t border-b">
							<div className="absolute p-3 left-3 hover:bg-gray-300 rounded-full cursor-pointer">
								<svg
									fill="none"
									viewBox="0 0 24 24"
									strokeWidth={1.5}
