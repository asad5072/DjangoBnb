const SearchFilter = () => {
	return (
		<div className="h-[48px] lg:h-[64] flex flex-row items-center justify-between shadow bg-green-50 rounded-full">
			...
			<div className="p-2">
				<div className="cursor-pointer p-2 lg:p-4 bg-red-500 hover:bg-red-600 transition rounded-full text-white">
					<svg
						viewBox="0 0 32 32"
						style={{
							display: "block",
